...
template <typename epicsType> int dldDetectorv2::computeArray(int sizeX, int sizeY)
{
    int simMode=0;
...
/** Template function to compute the simulated detector data for any data type */
template <typename epicsType> int dldDetectorv2::computeLinearRampArray(int sizeX, int sizeY)
{
...
template <typename epicsType> int dldDetectorv2::computePeaksArray(int sizeX, int sizeY)
{
...
void dldDetectorv2::setShutter(int open)
{
    int shutterMode;
...
int dldDetectorv2::computeImage()
{
    int status = asynSuccess;
...
/** Constructor for dldDetectorv2; most parameters are simply passed to ADDriver::ADDriver.
  ...
  */
dldDetectorv2::dldDetectorv2(const char *portName, int maxSizeX, int maxSizeY, NDDataType_t dataType,
...

{
    ...
    status = (epicsThreadCreate("DLDDetTask",
...
static const iocshArg * const cfgArgs[] =  {&cfgArg0,
                                            &cfgArg1,
                                            &cfgArg2,
                                            &cfgArg3,
                                            &cfgArg4,
